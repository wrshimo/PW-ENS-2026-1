<?php
require_once 'conexao.php'; // Caminho correto, na raiz

try {
    // A variável $pdo é criada diretamente em conexao.php
    $stmt = $pdo->prepare('SELECT id, nome, preco, categoria, imagem, descricao FROM produtos');
    $stmt->execute();
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item category-filter" href="#"
                                        data-category="Eletrônicos">Eletrônicos</a></li>
                                <li><a class="dropdown-item category-filter" href="#" data-category="Roupas">Roupas</a>
                                </li>
                                <li><a class="dropdown-item category-filter" href="#" data-category="Livros">Livros</a>
                                </li>
                                <li><a class="dropdown-item category-filter" href="#" data-category="Casa e Jardim">Casa
                                        e Jardim</a></li>
                            </ul>
                        </li>
                    ...
                    <form class="d-flex" role="search" onsubmit="return false;">
                        <input class="form-control me-2" type="search" id="name-search" placeholder="Buscar por nome"
                            aria-label="Buscar">
                    </form>
                    <div class="d-flex align-items-center ms-3">
                        <a href="#" class="text-white text-decoration-none" id="cart-icon" data-bs-toggle="popover"
                            ...
                            <span id="cart-count"
                                class="badge rounded-pill bg-danger position-absolute translate-middle">0</span>
                        </a>
    ...
    <div class="container mt-4">
        ...
        <section id="lab-box" class="mb-4 p-3 border rounded bg-light">
            ...
            <button id="load-from-json-btn" class="btn btn-success">
                Recarregar do JSON
            </button>
        </section>
        ...
        <div class="row">
            <main class="col-md-12">
                ...
                <hr>
                <section id="cadastro" class="mt-5">
                    <h2>Contato</h2>
    ...
    <script>
        // Injeta os dados do banco de dados em uma variável JS
        // JSON_NUMERIC_CHECK converte strings numéricas (como preço) para números
        const produtosDoBanco = <?php echo json_encode($produtos_db, JSON_UNESCAPED_UNICODE | JSON_NUMERIC_CHECK); ?>;
    </script>
